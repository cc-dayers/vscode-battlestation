...
const server = http.createServer((req, res) => {
  ...
  const testPageRoutes = { '/error': 'error.html', '/add-action': 'add-action.html', '/add-wizard': 'add-wizard.html', '/edit-action': 'edit-action.html', '/edit-action-workspace': 'edit-action-workspace.html', '/generate-config': 'generate-config.html', '/generate-config-welcome': 'generate-config-welcome.html', '/workflow-builder': 'workflow-builder.html' };
