...
export default defineConfig({
    files: [
        ...
        'src/test/suite/settings.test.ts',
         ...
         'src/test/suite/agentService.test.ts',
         'src/test/suite/managedWorktreeLanguageModelToolService.test.ts',
         'src/test/suite/toolLoopService.test.ts',
         'src/test/suite/orchestrationRoutingService.test.ts',
         'src/test/suite/worktreeService.test.ts',
         'src/test/suite/features.test.ts',
         'src/test/suite/jobLogService.test.ts',
         'src/test/suite/jobScheduler.test.ts',
         'src/test/suite/jobAdminView.test.ts',
         'src/test/suite/battles.test.ts',
         'src/test/suite/battleProviderService.test.ts',
         'src/test/suite/orchestrationStateService.test.ts',
    ],
    version: 'stable',
    workspaceFolder: '.',
    launchArgs: [
